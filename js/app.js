...
// call when   the readyState attribute changes 
xhr.onreadystatechange = function () {
  ...
  if (xhr.readyState == 4 && xhr.status == 200) {
    ...
    // call the showProducts(), passing in the parsed JSON string
...
// function that formats the string with HTML tags, and render the result
function showProducts(data) {
  ...
  // render the object data
      document.getElementById('main__item__product').innerHTML = mainProductTemplate;
